...
Team G-Revolution is presented in the order: Tyson, Max, Ray with power 20,40,60
Team all-started is presented in the order : x , y, z with power 30,50,60
Each player can fight one at a time once ("In this order Team-G lost all battle") if they suffle their 
Ordered they can win maximum of 2 battle 
